			...
			<tr>
				...
				<td width="1200" valign="top">
					<table>
						...
						try {
							if (status == true) {
								double result = controller.checkBalance(acc_no, name, password);
								...
								out.print("<td id='text'>Account Info is:</td>");
								out.print("</table>");
								...
								out.print("<tr><th>CURRENT BALANCE:</th><td><span>&#8377;</span>"+ result + "</td></tr>");
								out.print("</table>");
							} else {
								out.print("Please check your username and Password");
								request.setAttribute("balance", "Please check your username and Password");
						%>
						<jsp:forward page="balanceView.jsp"></jsp:forward>
						<%
						}
						} catch (Exception e) {
						e.printStackTrace();
