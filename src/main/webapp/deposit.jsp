			...
			<tr>
				...
				<td width="1200" valign="top">
					...
					<table>
						...
						try {
							if (status == true) {
								double updatedBalance = controller.depositAmount(acc_no, name, password, amount);
								...
								out.print("<td id='texth' style='color:#50C878'> Amount of <span>&#8377;</span>"+ amount+" is deposited to Account Number "+acc_no+ "</td>");
								out.print("</table>");
								out.print("<br>");
						...
						%>
						<jsp:forward page="depositView.jsp"></jsp:forward>
						<%
						}
						} catch (Exception e) {
						e.printStackTrace();
